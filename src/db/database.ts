...
export async function initializeDatabase() {
  ...
  await addColumnIfMissing(database, "music_tracks", "resume_seconds", "resume_seconds REAL NOT NULL DEFAULT 0");
  await addColumnIfMissing(database, "music_tracks", "lyrics_text", "lyrics_text TEXT");
